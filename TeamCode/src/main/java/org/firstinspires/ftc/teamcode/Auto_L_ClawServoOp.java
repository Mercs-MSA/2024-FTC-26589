...
public class Auto_L_ClawServoOp {
    ...
    // Constructor
    public Auto_L_ClawServoOp(@NonNull HardwareMap hardwareMap, Gamepad secondGamePad, Telemetry telemetry) {
        // claw initialization
